from part1 import puzzle, parse_input, find_missing_element
...
def test_missing_elements():
    for serie, missing_element in zip(parsed_input, missing_elements):
        assert find_missing_element(serie) == missing_element
...
def test_real_not_right_response():
    with open('input.txt', 'r') as indata:
        assert puzzle(indata.read()) == 2043677056
